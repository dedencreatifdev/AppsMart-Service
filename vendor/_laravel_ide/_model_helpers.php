...
namespace App\Models {
	 ...
	 * @property string $id
	 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\LevelPermision> $levelPermision
	 * @property-read int|null $levelPermision_count
	 * @method static \Illuminate\Database\Eloquent\Builder<Level>|Level whereId($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<Level>|Level whereNama($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<Level>|Level whereDeletedAt($value)
	...
	/**
	 * App\Models\LevelPermision
	 *
	 * @property \Illuminate\Support\Carbon|null $updated_at
	 * @property \Illuminate\Support\Carbon|null $created_at
	 * @property string|null $deleted_at
	 * @property bool|null $hapus
	 * @property bool|null $edit
	 * @property bool|null $tambah
	 * @property bool|null $lihat
	 * @property string|null $nama
	 * @property string $level_id
	 * @property string $id
	 * @method static \Illuminate\Database\Eloquent\Builder<LevelPermision>|LevelPermision whereId($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<LevelPermision>|LevelPermision whereLevelId($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<LevelPermision>|LevelPermision whereNama($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<LevelPermision>|LevelPermision whereLihat($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<LevelPermision>|LevelPermision whereTambah($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<LevelPermision>|LevelPermision whereEdit($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<LevelPermision>|LevelPermision whereHapus($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<LevelPermision>|LevelPermision whereDeletedAt($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<LevelPermision>|LevelPermision whereCreatedAt($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<LevelPermision>|LevelPermision whereUpdatedAt($value)
	 * @method static \Illuminate\Database\Eloquent\Builder<LevelPermision>|LevelPermision newModelQuery()
	 * @method static \Illuminate\Database\Eloquent\Builder<LevelPermision>|LevelPermision newQuery()
	 * @method static \Illuminate\Database\Eloquent\Builder<LevelPermision>|LevelPermision query()
	 * @method static mixed select($columns)
	 * @method static mixed selectSub($query, $as)
	 * @method static mixed selectRaw($expression, array $bindings)
	 * @method static mixed fromSub($query, $as)
	 ...
	 * @mixin \Illuminate\Database\Query\Builder
	 */
	class LevelPermision extends \Illuminate\Database\Eloquent\Model
	{
		//
	}
	 ...
	 * @method static \Illuminate\Database\Eloquent\Builder<User>|User whereLevelId($value)
